(function(){
"use strict";
var SECTORS={AAPL:"Technology", ABBV:"Health Care", ABT:"Health Care", AEE:"Utilities", AEP:"Utilities", AES:"Utilities", AFL:"Insurance", AIG:"Insurance", AJG:"Insurance", ALL:"Insurance", AMD:"Technology", AMGN:"Health Care", AMZN:"Technology", AON:"Insurance", BDX:"Health Care", BMY:"Health Care", BRO:"Insurance", CAT:"Industrials", CB:"Insurance", CINF:"Insurance", CMS:"Utilities", CNP:"Utilities", COP:"Energy", CVS:"Health Care", CVX:"Energy", D:"Utilities", DE:"Industrials", DHR:"Health Care", DOV:"Industrials", DUK:"Utilities", ED:"Utilities", EMR:"Industrials", EOG:"Energy", ETN:"Industrials", EVRG:"Utilities", EXC:"Utilities", FE:"Utilities", GD:"Industrials", GILD:"Health Care", GOOGL:"Technology", HIG:"Insurance", HON:"Industrials", ITW:"Industrials", JNJ:"Health Care", LLY:"Health Care", LMT:"Industrials", LNT:"Utilities", MDT:"Health Care", MET:"Insurance", META:"Technology", MMM:"Industrials", MPC:"Energy", MRK:"Health Care", MSFT:"Technology", NI:"Utilities", NOC:"Industrials", NVDA:"Technology", OXY:"Energy", PCG:"Utilities", PEG:"Utilities", PFE:"Health Care", PFG:"Insurance", PGR:"Insurance", PH:"Industrials", PPL:"Utilities", PRU:"Insurance", PSX:"Energy", ROK:"Industrials", RTX:"Industrials", SLB:"Energy", SO:"Utilities", SRE:"Utilities", SWK:"Industrials", TMO:"Health Care", TRV:"Insurance", TSLA:"Technology", UNH:"Health Care", WEC:"Utilities", XEL:"Utilities", XOM:"Energy"};
...
function renderUniverse(){
  ...
  var parts=Object.keys(bySec).sort().map(sec=> sec+' ('+bySec[sec].length+'): '+bySec[sec].sort().join(', '));
  el.textContent = syms.length+' symbols x 10 years of daily bars, restricted to the six winning sectors from the out-of-sample study (staples, REITs and regional banks removed). '+parts.join('  |  ');
}
