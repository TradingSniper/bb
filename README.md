...
MEAN-REVERSION (default, the verified winner): buy when price touches the lower band (20, 2) while above the 200-day average, skipping >4% news days. Target: return to the 20-day mean within 30 bars. Stop: 3 x ATR(14). Out-of-sample on 161 symbols x 10 years: 72.5% win rate, +0.17R per trade after 10bps costs (n=2,623). Losses are ~3x the size of wins - position sizing decides survival.
