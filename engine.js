// BB Verifier engine v3 - identical logic powers the backtest in this app and the research analysis.
...
function bbAnalyze(rows, opts){
  ...
  var BB_LEN=opts.bbLen||20, BB_MULT=opts.bbMult||2, SQ_LOOK=opts.sqLook||126, SQ_PCT=opts.sqPct||0.20,
      ...
      COOLDOWN=opts.cooldown!=null?opts.cooldown:5, DIR=opts.dir||0,
  ...
  for(var i=0;i<lastI;i++){
    ...
    for(var j=ei+1;j<=ei+HORIZON;j++){
      ...
      if(fav>=tgt){ res='hit'; r=TARGET; resBar=j; break; }
    }
